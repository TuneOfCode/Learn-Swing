...
public class BusinessPerson extends Person implements Tax {
	...
	public BusinessPerson(String birthday, String gender, String blood_type,
			String name, String citizenID, String phone, String email,
			double salary, double business_income, double other_income) {
	...
	public double payTax(double income, int start_time, int end_time) {
		...
		double percentTax = (income > income_50) ? (3.0/100) : ((income > income_10 && income <= income_50) ? (2.0/100) : 0);
